    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-medium">Predicted Winner</h3>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center">
            <div 
              className="w-24 h-24 rounded-full overflow-hidden flex items-center justify-center mb-4 md:mb-0 md:mr-6"
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-2xl md:text-3xl font-medium">{winner.team.name}</h2>
      ...
      >
        <h3 className="text-lg font-medium mb-4 text-center">All Teams Ranking</h3>
          ...
          <AnimatePresence>
            {sortedPredictions.map((prediction, index) => (
              ...
              >
                ...
                <div 
                  className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center mr-4"
